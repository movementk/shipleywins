...
<body class="sub internal-consulting">
    ...
    <!-- Content Start -->
    <main id="content" class="proposal-diagnosis sub-main-top">
        <div class="container">
            ...
            <h4 class="sub-title">Proposal Diagnostic Consulting</h4>
            <p class="summary">
                Is our proposal a proposal that is easy to understand and easy to evaluate by the evaluator? Moreover, what is the level of our proposal compared to global companies?<br>
                Use the evaluation criteria of our proposal by Shipley, a consulting firm selected by 43 of the Fortune Top 50, to assess the competitiveness of our proposal and to check the competitiveness of our proposal in the global market.
            </p>
            <div class="bidbench">
                <h5>Proposal Precision Diagnostic Program Shipley Bid Bench</h5>
                <p>The Bid bench is a big data-based proposal evaluation program developed by Shipley UK. In the overseas market, it can also confirm the competitiveness of its proposal within the same industry compared to its competitors.</p>
                <figure>
                ...
                <div class="details">
                    ...
                    <ul>
                        ...
                        <li>Consumer Products &amp; Retail Education</li>
                        <li>Engineering, Manufacturing &amp; Construction</li>
                        <li>Entertainment, Hospitality &amp; Leisure</li>
                        <li>Finance, Insurance &amp; Banking</li>
                        <li>Government – Local</li>
                        <li>Government – Central</li>
                        <li>Healthcare, Pharmaceuticals &amp; Biomedical</li>
                    ...
                    <figure>
                        ...
                        <figcaption class="sr-only">
                            <ol>
                                <li>
                                    <h5>사전인터뷰</h5>
                                    <p>사전미팅을 통해 기업니즈 확인 및 진단 작업에 반영 (비즈니스 특성, 영업정보)</p>
                                </li>
                                <li>
                                    <h5>진단의뢰 제안서 수신</h5>
                                ...
                                <li>
                                    <h5>맞춤형 진단 수행</h5>
                                    <p>국내/해외사업의 다양한 목적과 형태에 따라 맞춤형 정밀진단 수행</p>
                                </li>
                                <li>
                                    <h5>진단보고서 제공 및 진단결과 리뷰 제공</h5>
