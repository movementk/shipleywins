...
<body class="sub internal-consulting">
    ...
    <!-- Content Start -->
    <main id="content" class="business-consulting">
        <div class="container">
            <p class="summary">
                Have you ever been a best man in a bid?<br>
                Alternatively, have your efforts in building relationship will not always return as a success in business?<br>
                Make your position in business better with business strategies and solution development based on winning strategies!
            </p>
            ...
            <div class="container">
                ...
                <div class="article-content">
                    <ol class="square-list">
                        <li>
                            <span>1</span>
                            <strong>Creating a favorable market for you</strong>
                            <p>
                                You can qualify for a business from a customer, or you can make a proposal request favorable to your company.
                            </p>
                        </li>
                        <li>
                            <span>2</span>
                            <strong>Positioning Improvements</strong>
                            <p>
                                Systematic pre-sales leads customers to recognize you as an expert.
                            </p>
                        </li>
                        <li>
                            <span>3</span>
                            <strong>Improving the feasibility of obtaining orders</strong>
                            <p>
                                Raise the probability of business success through systematic sales activities.
                            </p>
                        </li>
                    </ol>
                </div>
