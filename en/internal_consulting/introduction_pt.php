...
<body class="sub internal-consulting">
    ...
    <!-- Content Start -->
    <main id="content" class="sub-main-top introduction-pt">
        <div class="container">
            <div class="sub-nav dropdown">
                <button class="btn btn-default dropdown-toggle" type="button" id="sub-nav-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    Company Presentation Consultation
                </button>
                <ul class="dropdown-menu" aria-labelledby="sub-nav-menu">
                    ...
                    <li class="active"><a href="/en/internal_consulting/introduction_pt.php">Company Presentation Consultation</a></li>
                </ul>
            </div>
            ...
            <div class="container">
                ...
                <div class="article-content">
                    <ol class="square-list">
                        ...
                        <li>
                            <span>2</span>
                            <strong>Message-driven PT, not information</strong>
                            <p>
                                The company introduction material is easy to be made up of a list of information to introduce the company. Through the consultation, do not list the introductory information, but develop an introductory material with clear "message" to deliver. This allows prospective customers to intuitively understand the message you want to deliver.
                            </p>
                        </li>
                        <li>
                            <span>3</span>
